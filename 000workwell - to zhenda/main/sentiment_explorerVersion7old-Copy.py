...
negation_list = ['cannot', 'cant', 'can\'t','can’t','couldnt', 'couldn\'t', 'couldn’t','didnt', 'didn\'t', 'didn’t','doesnt',
                 'doesn\'t', 'doesn’t', 'dont', 'don\'t', 'don’t','hadnt', 'hadn\'t', 'hadn’t', 'hasnt', 'hasn\'t', 'hasn’t', 'havent',
                 'haven\'t', 'haven’t', 'mustnt', 'must\'nt', 'must’nt', 'mustn\'t', 'mustn’t', 'neednt', 'need\'nt', 'need’nt', 'needn\'t',
                 'needn’t', 'neither', 'never', 'nor', 'not', 'oughtnt', 'ought\'nt', 'ought’nt', 'oughtn\'t', 'oughtn’t', 'shant'
                 ,'shan\'t', 'shan’t', 'shouldnt', 'should\'nt', 'should’nt', 'shouldn\'t', 'shouldn’t', 'wont', 'won\'t', 'won’t',
                 'wouldnt', 'wouldn\'t', 'wouldn’t', 'don', 'dun', 'lack', 'lacked', 'lacking', 'lacks', 'limit', 'limited', 'rare', 'rarely', 'could have']
...
def recognise_sarcasm(input_list):
    ...
    Returns:
        int: 0 or -1
    """
    if is_subsequence(input_list, [1, -1, 11]) or is_subsequence(input_list, [1, -1, 1]) or is_subsequence(input_list, [1, 11, 1]) or is_subsequence(input_list, [-1, 1, -1]) or is_subsequence(input_list, [-1, 11, 1]) or is_subsequence(input_list, [11, 1, 11]) or is_subsequence(input_list, [11, 1, -1]):
        return -1
    elif is_subsequence(input_list, [1, -1]) or is_subsequence(input_list, [1, 11]) or is_subsequence(input_list, [-1, 1]):
        return -1
    else:
        return 0
